...
const translations = {
  ...
  ru: {
    ...
    "performance3.title": "Концерт №4 для фортепиано с оркестром Бетхове��а",
